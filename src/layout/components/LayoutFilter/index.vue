<template>
  <el-form :model="query" :size="size" :inline="true">
    ...
    <el-form-item v-if="typeof query.gameid != 'undefined'">
      <el-select v-model="query.gameid" @change="changeGame" filterable :multiple="gameMul" placeholder="游戏">
        <el-option
    ...
    <el-form-item  v-if="typeof query.ProxyRegion != 'undefined'">
      <el-select v-model="query.ProxyRegion" placeholder="地区">
        <el-option key="1" label="欧美洲" value="omz"></el-option>
        <el-option key="2" label="新加坡" value="xjp"></el-option>
      </el-select>
    </el-form-item>

    <el-form-item  v-if="typeof query.tzn != 'undefined'">
      <el-select v-model="query.tzn" placeholder="地区">
        <el-option key="1" label="-5区" value="-5"></el-option>
        <el-option key="2" label="8区" value="8"></el-option>
      </el-select>
    </el-form-item>
