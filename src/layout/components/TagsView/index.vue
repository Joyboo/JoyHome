<template>
  <div id="tags-view-container" class="tags-view-container">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper" @scroll="handleScroll">
      ...
      <span v-if="device !== 'mobile'" class="tags-view-item joy-refresh" @click="doRefresh">
        <el-tooltip content="刷新当前标签" placement="bottom">
          <i class="el-icon-refresh" />
        </el-tooltip>
      </span>

      <span v-if="device !== 'mobile'" class="tags-view-item joy-refresh-all" @click="doRefreshAll">
