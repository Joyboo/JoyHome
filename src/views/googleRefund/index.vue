<template>
  <div class="view-container">
    <layout-filter :query="query" :loading="loading" @search="search">
      ...
      <el-form-item>
        <el-input v-model="query.whereValue" clearable :placeholder="query.whereKey ? whereKey[query.whereKey] : ''" @change="search" />
      </el-form-item>

      <template #after>
        <el-form-item style="float: right;">
          <export-data :query="query" export-url="/google_refund/export" />
        </el-form-item>
    ...
    <pie-chart title="退款金额top 10 UID" :data="pietoall" style="float: left" width="50%" height="600px" />
    <pie-chart title="退款次数top 10 原因" :data="piereason" style="float: left" width="50%" height="600px" />
  </div>
</template>
